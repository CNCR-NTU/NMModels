...
#print(rawHex)
file2 = open('FHN.csv',"w+")
file2.close()

file2 = open('FHN.csv',"a+")
...
data = np1.genfromtxt('FHN.csv', delimiter=';', names=['timestamp', 'AP', 'Spike'])

plt.figure(1)
plt.suptitle("FPGA results FHN (A) tonic spiking", fontsize=16)
#plt.suptitle("FPGA results FHN (B) phasic spiking", fontsize=16)
#plt.suptitle("FPGA results FHN (C) tonic bursting", fontsize=16)
plt.subplot(211)
plt.show()
