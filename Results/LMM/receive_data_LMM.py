...
data = np1.genfromtxt('LMM.csv', delimiter=';', names=['timestamp', 'Force'])
plt.figure(2)
plt.suptitle("Muscle contraction - LMM", fontsize=16)
plt.subplot(211)
plt.show()
