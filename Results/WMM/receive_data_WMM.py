...
data = np1.genfromtxt('WMM.csv', delimiter=';', names=['timestamp', 'Force'])
plt.figure(2)
plt.suptitle("Muscle contraction - WMM", fontsize=16)
plt.subplot(211)
plt.show()
